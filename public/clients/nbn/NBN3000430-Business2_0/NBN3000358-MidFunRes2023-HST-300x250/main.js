...
function StartBanner() {
	...
	/* prettier-ignore */
	FRAME1.to("#frame1", {duration: 5, scale: 1.08, transformOrigin: "25% 50%", ease: Linear.easeNone}, 0)
	...
	for (var i = 0; i < glitter[0].length; ++i) {
		...
		FRAME2.to(glitter[0][i], { duration: 5, ease: Linear.easeNone, x: Math.random() * 60 - 30, y: Math.random() * -40 - 10 }, 0);
	}
	/* prettier-ignore */
	FRAME2.from("#frame2", {opacity: 0, ease: Power2.easeIn, duration: 0.8}, 0)
        ...
        .to("#frame2", {duration: 5, scale: 1.1, ease: Linear.easeNone}, 0)
	...
	FRAME3.from("#frame3", {opacity: 0, ease: Power2.easeIn, duration: 0.8}, 0)
        ...
        .to("#ipad1", { duration: 5, y: -30, rotation: 2, ease: Linear.easeNone }, 0)
        .to("#ipad2", { duration: 5, y: -15, rotation: -2, ease: Linear.easeNone }, 0)
        .to("#ipad3", { duration: 5, y: -10, rotation: 3, ease: Linear.easeNone }, 0)
        .to("#ipad4", { duration: 5, y: -7, rotation: -1, ease: Linear.easeNone }, 0);
	...
	/* prettier-ignore */
	FRAME4.from("#frame4", {opacity: 0, ease: Power2.easeIn, duration: 0.5}, 0)
        .to("#logo", {opacity: 0, ease: Power2.easeIn, duration: 0.4}, 0)
        .to("#frame3-copy g", {scale: 0, opacity: 0, ease: Power3.easeIn, duration: 0.25, stagger: 0.05}, 0)
        .from("#logo-endframe", {opacity: 0, ease: Power3.easeIn, duration: 0.5}, 0.25)
        ...
        .from("#terms", {opacity: 0, ease: Power2.easeIn, duration: 0.5}, "-=0.2")
