...
const startBanner = () => {
    ...
    for (i = 0; i < 70; i++) {
        ...
        particle.alpha = FauxRandom() * 0.025 + 0.1
    ...
    banner.scene.sprite.x = banner.canvas.width * 0.5 - 5
    banner.scene.sprite.y = banner.canvas.height * 0.5 - 15
    banner.scene.sprite.scale = 1.01
    ...
    const FRAME3 = new gsap.timeline()
        ...
        .to(".bar", { duration: 0.7, height: "4.1em", y: 0, ease: Power2.easeInOut }, "-=0.6")
